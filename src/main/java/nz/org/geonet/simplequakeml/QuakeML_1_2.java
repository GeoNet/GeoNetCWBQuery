...
/**
 * Implements SimpleQuakeML for QuakeML 1.2
 *
 * @author: Geoff Clitheroe
 * Date: 5/3/13
 * Time: 11:24 AM
 */
public class QuakeML_1_2 implements SimpleQuakeML {
    public Event read(InputStream inputStream) throws Exception {
        InputStream xslt = this.getClass().getClassLoader().getResourceAsStream("xsl/quakeml1.2tosimpleXML.xsl");
